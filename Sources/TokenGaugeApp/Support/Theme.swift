...
enum Theme {
    ...
    enum Layout {
        ...
        static let historyMonthWidth: CGFloat = 69
        static let historyMonthGap: CGFloat = 8
        static let minimumRingUnifiedWidth: CGFloat = 440
        static let quotaRingCellWidth: CGFloat = 118
        static let quotaRingSpacing: CGFloat = 10
        static let ringSectionSpacing: CGFloat = 10
        static let ringHeaderSpacing: CGFloat = 14
        static let ringRowSpacing: CGFloat = 8
        static let ringTitleHeight: CGFloat = 28
        static let minimumRingCardWidth: CGFloat = 170
        static let cardPadding: CGFloat = 12
        static let quotaRingDiameter: CGFloat = 68
        static let quotaRingLineWidth: CGFloat = 5
        static let quotaRingPercentageSize: CGFloat = 17
        static let quotaRingSingleDiameter: CGFloat = 84
        static let quotaRingSingleLineWidth: CGFloat = 6
        static let quotaRingSinglePercentageSize: CGFloat = 20
        static let quotaRingRowDiameter: CGFloat = 44
        static let quotaRingRowLineWidth: CGFloat = 4
        static let quotaRingRowPercentageSize: CGFloat = 12
